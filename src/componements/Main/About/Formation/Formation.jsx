      ...
      <div className="formation_container">
        ...
        <div className="formation_content">
          ...
          <div className="formation_content_item">
            ...
            <p>
              Formation au six sigma yellow belt pour l'amélioration continue et
          ...
          <div className="formation_content_item">
            ...
            <p>Formation de 1 an en énergie renouvelable</p>
            <p>2011-2012</p>
          </div>
          <hr className="link_down" />
          <hr className="link_down" />
          <div className="formation_content_item">
            ...
            <p>Formation de 3 ans en électrotechnique</p>
            <p>2009-2011</p>
          </div>
        </div>
      </div>
